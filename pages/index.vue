<template>
    <div>
        <div class="w-10/12 mx-auto text-black">
            <Categories />
            <div class="mb-10" v-for="post in posts" key="index">
                <img src="/test_blog.jpg" style="height: 18rem;" class="bg-auto w-full rounded-3xl">
                <div class="my-4"><span
                        class="bg-red-500 rounded-full text-black font-semibold px-4 py-1">Catégorie</span></div>
                ...
                <div class="py-1 mb-2 flex justify-between">
                    <div class="flex mt-1">
                        <img src="/Gouvernement_N.png" class="w-8 h-8 mt-1 mr-3 rounded-full border-2" alt="">
                    ...
                    <div class="mr-2 group">
                        <div class="flex">
                            ...
                            </div><span class="text-lg mt-1">12</span>
                        </div>
                    </div>
                </div>
            </div>
