<template>
  <div>
    <div class="absolute top-5 left-5 hover:scale-110 transition duration-300 cursor-pointer">
      <Icon name="material-symbols:arrow-back" size="2rem" @click="$router.back()" />
    </div>
    <div
